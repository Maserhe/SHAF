...
from data_utils import base_path, squarepad_transform, targetpad_transform, FashionIQDataset
...
def clip_finetune_fiq(train_dress_types: List[str], val_dress_types: List[str],
    ...
    clip_model = CLIPModel.from_pretrained("patrickjohncyh/fashion-clip", local_files_only=True)
    clip_preprocess = CLIPProcessor.from_pretrained("patrickjohncyh/fashion-clip", local_files_only=True)
    ...
    if encoder == 'text':
        ...
        for param in clip_model.parameters():
            param.requires_grad = False
        for param in clip_model.image_model.parameters():
            ...
            with experiment.validate():
                ...
                for relative_val_dataset, classic_val_dataset, idx in zip(relative_val_datasets, classic_val_datasets,
                    ...
                    recall_at10, recall_at50 = compute_fiq_val_metrics(relative_val_dataset, clip_model,
                                                                       ...
                                                                       combining_function, clip_preprocess)
